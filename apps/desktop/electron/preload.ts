...
const api: QuillariumAPI = {
  ...
  updateProjectStoryStructure: (root, structure) => invoke('project:updateStoryStructure', root, structure),
  needsDisplayMigration: (root) => invoke('display:needsMigration', root),
  resetDisplayLayer: (root) => invoke('display:reset', root),
  setDisplayLayerEnabled: (root, enabled) => invoke('display:setEnabled', root, enabled),
  ...
  chooseSettingImage: (root, documentPath, altText) =>
    invoke('settingImage:choose', root, documentPath, altText),
  ...
  saveSettingCardStyle: (root, input) => invoke('settingCard:saveStyle', root, input),
  exportSettingCard: (root, input) => invoke('settingCard:export', root, input),
  ...
  recoverAssistantPromptBinding: (root, input) => invoke('assistant:recoverPrompt', root, input),
