...
describe('desktop IPC contract', () => {
  it('keeps the contract, handlers, and both preload implementations on the same 179 channels', async () => {
    ...
    expectUniqueCount(contractChannels, 179)
    expectUniqueCount(handlerChannels, 179)
    expectUniqueCount(typeScriptChannels, 179)
    expectUniqueCount(commonJsChannels, 179)
