...
describe('desktop IPC contract', () => {
  it('keeps the contract, handlers, and both preload implementations on the same 78 channels', async () => {
    ...
    expectUniqueCount(contractChannels, 78)
    expectUniqueCount(handlerChannels, 78)
    expectUniqueCount(typeScriptChannels, 78)
    expectUniqueCount(commonJsChannels, 78)
