...
describe('desktop IPC contract', () => {
  it('keeps the contract, handlers, and both preload implementations on the same 55 channels', async () => {
    ...
    expectUniqueCount(contractChannels, 55)
    expectUniqueCount(handlerChannels, 55)
    expectUniqueCount(typeScriptChannels, 55)
    expectUniqueCount(commonJsChannels, 55)
