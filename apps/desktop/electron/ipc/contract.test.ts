...
describe('desktop IPC contract', () => {
  it('keeps the contract, handlers, and both preload implementations on the same 166 channels', async () => {
    ...
    expectUniqueCount(contractChannels, 166)
    expectUniqueCount(handlerChannels, 166)
    expectUniqueCount(typeScriptChannels, 166)
    expectUniqueCount(commonJsChannels, 166)
