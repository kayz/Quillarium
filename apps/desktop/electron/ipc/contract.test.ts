...
describe('desktop IPC contract', () => {
  it('keeps the contract, handlers, and both preload implementations on the same 163 channels', async () => {
    ...
    expectUniqueCount(contractChannels, 163)
    expectUniqueCount(handlerChannels, 163)
    expectUniqueCount(typeScriptChannels, 163)
    expectUniqueCount(commonJsChannels, 163)
