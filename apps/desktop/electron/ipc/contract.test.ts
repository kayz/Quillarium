...
describe('desktop IPC contract', () => {
  it('keeps the contract, handlers, and both preload implementations on the same 81 channels', async () => {
    ...
    expectUniqueCount(contractChannels, 81)
    expectUniqueCount(handlerChannels, 81)
    expectUniqueCount(typeScriptChannels, 81)
    expectUniqueCount(commonJsChannels, 81)
