...
describe('desktop IPC contract', () => {
  it('keeps the contract, handlers, and both preload implementations on the same 174 channels', async () => {
    ...
    expectUniqueCount(contractChannels, 174)
    expectUniqueCount(handlerChannels, 174)
    expectUniqueCount(typeScriptChannels, 174)
    expectUniqueCount(commonJsChannels, 174)
