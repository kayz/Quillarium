...
describe('desktop IPC contract', () => {
  it('keeps the contract, handlers, and both preload implementations on the same 178 channels', async () => {
    ...
    expectUniqueCount(contractChannels, 178)
    expectUniqueCount(handlerChannels, 178)
    expectUniqueCount(typeScriptChannels, 178)
    expectUniqueCount(commonJsChannels, 178)
