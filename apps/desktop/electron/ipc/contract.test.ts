...
describe('desktop IPC contract', () => {
  it('keeps the contract, handlers, and both preload implementations on the same 172 channels', async () => {
    ...
    expectUniqueCount(contractChannels, 172)
    expectUniqueCount(handlerChannels, 172)
    expectUniqueCount(typeScriptChannels, 172)
    expectUniqueCount(commonJsChannels, 172)
